...
This is a basic example which estimates a simple VAR and identify using Cholesky decomposition, using [Stock and Watson (2001)](https://www.aeaweb.org/articles?id=10.1257/jep.15.4.101) data
